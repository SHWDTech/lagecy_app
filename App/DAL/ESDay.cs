...
namespace ESMonitor.DAL
{
	...
	public class EsDay
	{
		...
		public bool Exists(long id)
		{
			...
			var result= DbHelperSql.RunProcedure("T_ESDay_Exists",parameters,out rowsAffected);
			return result==1;
		}
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.EsDay GetModel(long id)
		{
			IDataParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.BigInt,8)
			};
			...
			var ds= DbHelperSql.RunProcedure("T_ESDay_GetModel",parameters,"ds");
		...
		/// 得到一个对象实体
		/// </summary>
		public Model.EsDay DataRowToModel(DataRow row)
		{
			var model=new Model.EsDay();
			if (row != null)
			{
