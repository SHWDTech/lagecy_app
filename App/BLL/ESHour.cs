...
namespace ESMonitor.BLL
{
	...
	public class EsHour
	{
		private readonly DAL.EsHour _dal=new DAL.EsHour();
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.EsHour> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.EsHour> DataTableToList(DataTable dt)
		{
			var modelList = new List<Model.EsHour>();
