...
namespace ESMonitor.BLL
{
	...
	{
		private readonly DAL.ModuleType _dal=new DAL.ModuleType();
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.ModuleType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.ModuleType> DataTableToList(DataTable dt)
		{
			var modelList = new List<Model.ModuleType>();
