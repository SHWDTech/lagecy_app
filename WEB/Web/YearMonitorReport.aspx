<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YearMonitorReport.aspx.cs" Inherits="Web.YearMonitorReport" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    </asp:DropDownList>年&nbsp;&nbsp; 污染类型：<asp:DropDownList ID="ddlPolutionKind" runat="server">
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gvReportShow" runat="server" BackColor="White" BorderColor="#DEDFDE"
                            ...
                            EnableModelValidation="True" Width="668px">
                            <Columns>
