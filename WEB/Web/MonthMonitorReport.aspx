<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthMonitorReport.aspx.cs" Inherits="Web.MonthMonitorReport" %>
        ...
        <div>
            <table >
                ...
                <tr>
                    ...
                    </asp:DropDownList>年<asp:DropDownList ID="ddlSelectMonth" runat="server">
                    </asp:DropDownList>
                        污染类型：<asp:DropDownList ID="ddlPolutionKind" runat="server">
                        </asp:DropDownList><asp:Button ID="btnSubmit" runat="server" Text="提交" style="margin-left: 5px; padding: 5px" OnClick="btnSubmit_Click" /></td>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gvReportShow" runat="server" BackColor="White" BorderColor="#DEDFDE"
                            ...
                            EnableModelValidation="True" Width="558px">
                            <Columns>
