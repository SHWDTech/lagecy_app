<%@ Page Title="T_ESHour" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="ESMonitor.Web.ESHour.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ValidDataNum" HeaderText="ValidDataNum" SortExpression="ValidDataNum" ItemStyle-HorizontalAlign="Center"  /> 
