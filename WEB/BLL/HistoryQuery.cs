...
namespace ESMonitor.BLL
{
    public partial class HistoryQuery
    {
        ...
        public DataSet GetList(int selectControl, DateTime statetime, DateTime endtime,int indexKind, int country) //获取增加条件的收索结果
        {
            return dal.GetList(selectControl, statetime, endtime, indexKind, country);
        }
