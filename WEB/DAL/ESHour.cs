...
namespace ESMonitor.DAL
{
    ...
    public partial class ESHour
    {
        ...
        public bool Exists(long Id)
        {
            ...
            int result = DbHelperSQL.RunProcedure("T_ESHour_Exists", parameters, out rowsAffected);
            if (result == 1)
            {
                return true;
            }
        ...
        public DataSet GetAvgPM25StatList(string country, string strWhere)
        {
            ...
            return DbHelperSQL.RunProcedure("T_ESHour_GetAvgPM25StatList", parameters, "ds");
        }
        ...
        public DataSet GetAvgPM100StatList(string country, string strWhere)
        {
            ...
            return DbHelperSQL.RunProcedure("T_ESHour_GetAvgPM100StatList", parameters, "ds");
        }
