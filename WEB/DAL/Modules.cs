...
namespace ESMonitor.DAL
{
	...
	public partial class Modules
	{
		...
		public bool Exists(string name)
		{
			...
			int result = DbHelperSQL.RunProcedure("T_Modules_Exists",parameters,out rowsAffected);
			if(result == 1)
			{
				return true;
			}
		...
		public ESMonitor.Model.Modules GetModel(int Id)
		{
			...
			ESMonitor.Model.Modules model=new ESMonitor.Model.Modules();
			DataSet ds= DbHelperSQL.RunProcedure("T_Modules_GetModel",parameters,"ds");
		...
		/// 得到一个对象实体
		/// </summary>
		public ESMonitor.Model.Modules DataRowToModel(DataRow row)
		{
			ESMonitor.Model.Modules model=new ESMonitor.Model.Modules();
			if (row != null)
			{
