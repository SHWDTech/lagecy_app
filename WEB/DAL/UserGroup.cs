...
namespace ESMonitor.DAL
{
	...
	public partial class UserGroup
	{
        ...
        public bool Exists(string name)
		{
			...
			int result= DbHelperSQL.RunProcedure("T_UserGroup_Exists",parameters,out rowsAffected);
			if(result==1)
			{
				return true;
			}
		...
		public ESMonitor.Model.UserGroup GetModel(int Id)
		{
			...
			DataSet ds= DbHelperSQL.RunProcedure("T_UserGroup_GetModel",parameters,"ds");
		...
		/// 得到一个对象实体
		/// </summary>
		public ESMonitor.Model.UserGroup DataRowToModel(DataRow row)
		{
			ESMonitor.Model.UserGroup model=new ESMonitor.Model.UserGroup();
			if (row != null)
			{
